      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Link href="/bookings" style={{ color: 'var(--color-primary, #F1D16A)', textDecoration: 'none' }}>
              Bookings
            </Link>
            <Link href="/users" style={{ color: 'var(--color-primary, #F1D16A)', textDecoration: 'none' }}>
              Users
            </Link>
            <Link href="/settings" style={{ color: 'var(--color-primary, #F1D16A)', textDecoration: 'none' }}>
              Settings
            </Link>
          </div>
        </div>
