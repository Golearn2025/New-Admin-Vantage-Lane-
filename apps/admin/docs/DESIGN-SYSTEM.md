...
### Light Theme Mapping
```css
--color-accent-500: #eab308    /* Primary brand gold */
--color-accent2-500: #d4a307   /* Hover/focus gold */
--color-border-focus: #eab308   /* Focus rings */
```

### Dark Theme Mapping  
```css
--color-accent-500: #f1d16a    /* Lighter gold for dark backgrounds */
--color-accent2-500: #f7e397   /* Hover state in dark mode */
--color-border-focus: #f1d16a   /* Focus rings in dark mode */
```
